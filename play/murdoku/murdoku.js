...
(function () {
  ...
  const T = L === "pt" ? {
    ...
    solvedCulprit: (t, name, g) => `🎉 Resolvido em ${t}! ${name} ficou sozinh${g === "f" ? "a" : "o"} com a vítima. ${g === "f" ? "A culpada" : "O culpado"} é ${g === "f" ? "a" : "o"} ${name}.`,
    ...
    how: [
      ...
      "A <b>vítima</b> não tem pistas, por isso fica na única célula que sobra no fim.",
    ...
    solvedCulprit: (t, name, g) => `🎉 Solved in ${t}! ${name} was alone with the victim. The culprit is ${name}.`,
    ...
    how: [
      ...
      "The <b>victim</b> has no clues, so they're in the one cell left at the end.",
