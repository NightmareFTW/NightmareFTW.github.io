/* Epic Seven — Heroes Database.
   ...
   hero.html for base stats, skills, Fribbels builds, RTA data, exclusive
   equipment, awakenings and memory imprints.
...
function buildControls() {
  els.controls.innerHTML = `
    ...
    <select id="f-sort" class="sort-select">${opt("grade", "Sort: Grade", sortBy)}${opt("name", "Sort: Name", sortBy)}${opt("pvp", "Sort: PvP Tier", sortBy)}</select>`;
