...
(function () {
  ...
  if (!document.querySelector('script[data-nftw-steam]')) {
    ...
    s.src = "/assets/js/steam-alerts.js?v=6e6afbe5"; s.defer = true; s.setAttribute("data-nftw-steam", "");
  ...
  const DICT = {
    ...
    "Unlock everything at once, or just one DLC at a time.": "Desbloqueia tudo de uma vez, ou apenas uma DLC de cada vez.",
    "A full walkthrough for Chaos": "Um guia completo para o Chaos",
    "Every Secret needed to unlock Vampire Survivors' final character, phase by phase.": "Todos os Secrets necessários para desbloquear a personagem final do Vampire Survivors, fase a fase.",
    "Vampire Survivors joins the hub": "Vampire Survivors chega ao hub",
    "A spoiler-safe character database plus a full achievements checklist.": "Uma base de dados de personagens sem spoilers, mais uma checklist completa de conquistas.",
    "Palworld joins the hub": "Palworld chega ao hub",
    "Every Pal, its passive skills, and a breeding calculator.": "Todos os Pals, as suas skills passivas, e uma calculadora de reprodução.",
    "Farever joins the hub": "Farever chega ao hub",
    "Class builds, a weapons guide and a dungeons checklist.": "Builds por classe, um guia de armas e uma checklist de dungeons.",
    // ---- Account / profile ----
    ...
    "Secret": "Secreta", "Default": "Inicial", "Unlocked": "Desbloqueada",
